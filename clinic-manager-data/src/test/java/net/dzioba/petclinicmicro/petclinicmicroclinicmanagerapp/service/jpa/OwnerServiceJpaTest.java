...
class OwnerServiceJpaTest {
    ...
    void findAll() {
        ...
        List<Owner> referenceList = List.of(owner1, owner2);
        when(ownerRepository.findAll()).thenReturn(referenceList);
        //when
        List<Owner> resultSet = ownerServiceJpa.findAll();
        //then
        assertThat(resultSet).isEqualTo(referenceList);
    ...
    void findById() {
        ...
        //when
        Owner resultOwner = ownerServiceJpa.findById(OWNER_ID).orElse(null);
        //then
