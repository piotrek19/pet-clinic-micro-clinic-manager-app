...
@Service
public class PetDTOServiceJpa implements PetDTOService {
    ...
    @Autowired
    public PetDTOServiceJpa(PetService petService, PetMapper petMapper, OwnerService ownerService, PetTypeService petTypeService) {
