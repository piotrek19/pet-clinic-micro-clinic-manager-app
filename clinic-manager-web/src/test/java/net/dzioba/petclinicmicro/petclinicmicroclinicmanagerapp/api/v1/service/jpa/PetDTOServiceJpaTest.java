...
class PetDTOServiceJpaTest {
    ...
    void findById() {
        ...
        //given
        when(petService.findById(PET1_ID)).thenReturn(Optional.of(pet));
    ...
    void save() {
        ...
        when(ownerService.findById(OWNER_ID)).thenReturn(Optional.of(owner));
        when(petTypeService.findById(PET_TYPE_ID)).thenReturn(Optional.of(petType));
